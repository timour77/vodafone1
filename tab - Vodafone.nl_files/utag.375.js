//tealium universal tag - utag.375 ut4.0.201412191150, Copyright 2014 Tealium.com Inc. All Rights Reserved.
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1};u.t='@@',u.i=[],u.p=["//secure.adnxs.com/px?id=90580&t=2%%654%%","//secure.adnxs.com/px?id=90581&t=2##5000##%%665%%","//secure.adnxs.com/px?id=90582&t=2##10000##%%666%%","//secure.adnxs.com/px?id=90583&t=2##15000##%%667%%","//secure.adnxs.com/px?id=90584&t=2##30000##%%668%%","//secure.adnxs.com/px?id=90585&t=2##60000##%%669%%","","",];u.timeout='//tealium.hs.llnwd.net/o43/db.gif?utid='+utag.cfg.utid+'&tag_id='+id+'&pixel=';u._tto='';u.cachebust="enabled";u.map={};u.extend=[];u.send=function(a,b,c,d,e,f){if(u.ev[a]){for(c=0;c<u.p.length;c++){if(u.p[c]!=""){var x=u.rp(u.p[c],b);if(x.Url!=""){if(u.cachebust=="enabled"&&x.Url.indexOf("_rnd")<0){x.Url+="&_rnd="+Math.random();}
uep(u,i,x);}}}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('375','vodafone.nl-breakthrough');}catch(e){}
